...
## 🛠 Tools & Skills  
- **PostgreSQL** – Database design, query writing, joins, and optimization.  
- **ETL in SQL** – Data cleaning, normalization, and schema structuring.  
...
- **Analytical Storytelling** – Extending technical solutions into healthcare insights.  
...
## 🚀 Outcomes  
- Achieved **2nd Runner-Up position** in the company-wide SQL Hackathon.  
- Demonstrated expertise in **PostgreSQL for healthcare and clinical data analysis**.  
- Reinforced ability to balance **technical query optimization with clinical relevance**. 
