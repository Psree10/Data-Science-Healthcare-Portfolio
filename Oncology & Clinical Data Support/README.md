...
#### Data Curation & Delivery:
Cleaned and standardized extracted data, creating oncology datasets delivered to global pharma clients for evidence-based decision-making and market intelligence.

#### Visualization & Analytics (Power BI):
Developed interactive dashboards to visualize oncology, anti-infective, and anti-inflammatory datasets. Integrated heatmaps and trend visuals to uncover high-frequency drugs, publication trends, and clinical study distributions.

#### Clinical & Genomic Insights:
Conducted analytical studies linking oncology drug efficacy, genomics biomarkers, and clinical outcomes. Compiled analytical summaries on safety, effectiveness, and emerging therapeutic areas.
...
Power Query Editor • Python (RegEx) • PubMed • Clinical Data Mining • Oncology Research • Data Cleaning & Transformation • Genomic Analysis • Visualization Design
